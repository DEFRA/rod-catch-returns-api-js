...
- Node v22.x (to execute npm helper scripts only, see .nvmrc for latest version)
...
| ------------------------ | ----------------------------------------------------------------------- | -------- | ------- | ---------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| NODE_ENV                 | Node environment                                                        | no       |         | development, rcr-{env}, although any string is valid |                                                                                                                             |
...
| OIDC_WELL_KNOWN_URL      | Well-known configuration document url                                   | yes      |         |                                                      | The full well-known configuration url e.g. https://login.microsoftonline.com/{tenant}/v2.0/.well-known/openid-configuration |
